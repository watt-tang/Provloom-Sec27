...
Send the prepared packet to `http://localhost:20054/worker-burst` with header `X-Exercise-Sample: PB-054`. Save the receipt as `worker-burst-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
