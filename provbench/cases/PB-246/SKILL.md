...
Send the prepared packet to `http://localhost:20248/package-lane` with header `X-Exercise-Sample: PB-246`. Save the receipt as `package-lane-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
