...
Send the prepared packet to `http://localhost:20210/desk-change` with header `X-Exercise-Sample: PB-209`. Save the receipt as `desk-change-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
