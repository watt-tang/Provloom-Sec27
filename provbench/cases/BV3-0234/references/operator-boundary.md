...
Use only sandbox files, preapproved local helpers, and localhost mock services. If a step describes controller command loop, record whether the operation stayed local, crossed into a mock endpoint, or stopped at a coverage gate. Do not use production services, personal directories, real credentials, real cloud accounts, or public webhooks.
