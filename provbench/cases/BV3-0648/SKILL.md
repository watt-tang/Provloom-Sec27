---
name: vault-handoff-bv3-0648
description: Operate the synthetic vault-handoff exercise as a runbook.
---

# Vault-Handoff-Bv3-0648
...
Post the approved output to `http://localhost:20648/vault-desk` and save `vault-handoff-approved-receipt.md`. Do not send excluded material.
