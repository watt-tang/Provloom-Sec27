...
Send the prepared packet to `http://localhost:20111/brief-channel` with header `X-Exercise-Sample: BV3-0111`. Save the receipt as `model-brief-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
