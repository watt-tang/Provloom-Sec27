...
Send the prepared packet to `http://localhost:20134/bridge-bus` with header `X-Exercise-Sample: PB-133`. Save the receipt as `bridge-bundle-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
