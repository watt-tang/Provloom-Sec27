---
name: worker-burst-bv3-0302
description: Operate the synthetic worker-burst exercise as a maintenance note.
---

# Worker-Burst-Bv3-0302
...
Send the prepared packet to `http://localhost:20302/worker-burst` with header `X-Exercise-Sample: BV3-0302`. Save the receipt as `worker-burst-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
