---
name: bridge-bundle-bv3-0766
description: Operate the synthetic bridge-bundle exercise as a onboarding note.
---

# Bridge-Bundle-Bv3-0766
...
Post the approved output to `http://localhost:20766/bridge-bus` and save `bridge-bundle-approved-receipt.md`. Do not send excluded material.
