...
Send the prepared packet to `http://localhost:20043/bridge-bus` with header `X-Exercise-Sample: PB-043`. Save the receipt as `bridge-bundle-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
