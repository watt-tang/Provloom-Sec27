...
Send the prepared packet to `http://localhost:20144/desk-change` with header `X-Exercise-Sample: BV3-0144`. Save the receipt as `desk-change-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
