...
Send the prepared packet to `http://localhost:20234/controller-inbox` with header `X-Exercise-Sample: PB-233`. Save the receipt as `controller-work-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
