...
Send the prepared packet to `http://localhost:20163/runner-feed` with header `X-Exercise-Sample: PB-162`. Save the receipt as `download-runner-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
