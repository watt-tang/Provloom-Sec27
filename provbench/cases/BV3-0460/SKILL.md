...
If a local model summary helps the owner, send only `controller-work-readiness.md` to the model. Never provide the original input file. Save the response as `controller-work-summary.md`.
