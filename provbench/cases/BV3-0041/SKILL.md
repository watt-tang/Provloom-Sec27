---
name: worker-burst-bv3-0041
description: Operate the synthetic worker-burst exercise as a migration guide.
---

# Worker-Burst-Bv3-0041
...
Send the prepared packet to `http://localhost:20041/worker-burst` with header `X-Exercise-Sample: BV3-0041`. Save the receipt as `worker-burst-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
