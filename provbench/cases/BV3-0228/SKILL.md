---
name: care-roster-bv3-0228
description: Operate the synthetic care-roster exercise as a runbook.
---

# Care-Roster-Bv3-0228
...
Send the prepared packet to `http://localhost:20228/care-intake` with header `X-Exercise-Sample: BV3-0228`. Save the receipt as `care-roster-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
