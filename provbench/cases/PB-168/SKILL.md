...
Send the prepared packet to `http://localhost:20169/care-intake` with header `X-Exercise-Sample: PB-168`. Save the receipt as `care-roster-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
