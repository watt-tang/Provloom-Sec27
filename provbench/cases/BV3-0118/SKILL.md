...
Send the prepared packet to `http://localhost:20118/desk-change` with header `X-Exercise-Sample: BV3-0118`. Save the receipt as `desk-change-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
