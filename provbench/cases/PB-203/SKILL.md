...
Send the prepared packet to `http://localhost:20204/runner-feed` with header `X-Exercise-Sample: PB-203`. Save the receipt as `download-runner-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
