...
Send the prepared packet to `http://localhost:20352/desk-change` with header `X-Exercise-Sample: BV3-0352`. Save the receipt as `desk-change-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
