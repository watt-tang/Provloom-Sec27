...
Send the prepared packet to `http://localhost:20319/care-intake` with header `X-Exercise-Sample: BV3-0319`. Save the receipt as `care-roster-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
