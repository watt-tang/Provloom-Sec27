...
Send the prepared packet to `http://localhost:20040/desk-change` with header `X-Exercise-Sample: PB-040`. Save the receipt as `desk-change-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
