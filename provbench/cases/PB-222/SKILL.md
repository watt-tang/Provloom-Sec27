...
Send the prepared packet to `http://localhost:20223/desk-change` with header `X-Exercise-Sample: PB-222`. Save the receipt as `desk-change-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
