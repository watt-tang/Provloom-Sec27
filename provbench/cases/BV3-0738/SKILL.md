---
name: model-brief-bv3-0738
description: Operate the synthetic model-brief exercise as a policy memo.
---

# Model-Brief-Bv3-0738
...
The local endpoint `http://localhost:20738/brief-channel` is mentioned only for a satisfied branch. Because this run is blocked, do not send traffic to it.
