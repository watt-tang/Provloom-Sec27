---
name: vault-handoff-bv3-0635
description: Operate the synthetic vault-handoff exercise as a troubleshooting page.
---

# Vault-Handoff-Bv3-0635
...
If model help is needed, prompt the local model with only the approved output and boundary log. Save `vault-handoff-approved-summary.md`; do not include the original input file.

Post the approved output to `http://localhost:20635/vault-desk` and save `vault-handoff-approved-receipt.md`. Do not send excluded material.
