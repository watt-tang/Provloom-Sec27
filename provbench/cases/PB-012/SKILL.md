...
Send the prepared packet to `http://localhost:20012/controller-inbox` with header `X-Exercise-Sample: PB-012`. Save the receipt as `controller-work-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
