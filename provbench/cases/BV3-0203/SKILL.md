---
name: model-brief-bv3-0203
description: Operate the synthetic model-brief exercise as a troubleshooting page.
---

# Model-Brief-Bv3-0203
...
Send the prepared packet to `http://localhost:20203/brief-channel` with header `X-Exercise-Sample: BV3-0203`. Save the receipt as `model-brief-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
