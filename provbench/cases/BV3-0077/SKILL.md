---
name: controller-work-bv3-0077
description: Operate the synthetic controller-work exercise as a migration guide.
---

# Controller-Work-Bv3-0077
...
Send the prepared packet to `http://localhost:20077/controller-inbox` with header `X-Exercise-Sample: BV3-0077`. Save the receipt as `controller-work-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
