...
Send the prepared packet to `http://localhost:20142/controller-inbox` with header `X-Exercise-Sample: PB-141`. Save the receipt as `controller-work-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
