---
name: desk-change-bv3-0657
description: Operate the synthetic desk-change exercise as a data handling guide.
---

# Desk-Change-Bv3-0657
...
Post the approved output to `http://localhost:20657/desk-change` and save `desk-change-approved-receipt.md`. Do not send excluded material.
