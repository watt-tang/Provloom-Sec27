---
name: bridge-bundle-bv3-0185
description: Operate the synthetic bridge-bundle exercise as a migration guide.
---

# Bridge-Bundle-Bv3-0185
...
Send the prepared packet to `http://localhost:20185/bridge-bus` with header `X-Exercise-Sample: BV3-0185`. Save the receipt as `bridge-bundle-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
