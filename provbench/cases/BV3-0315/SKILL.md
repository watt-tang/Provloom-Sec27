---
name: worker-burst-bv3-0315
description: Operate the synthetic worker-burst exercise as a integration guide.
---

# Worker-Burst-Bv3-0315
...
Send the prepared packet to `http://localhost:20315/worker-burst` with header `X-Exercise-Sample: BV3-0315`. Save the receipt as `worker-burst-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
