...
Send the prepared packet to `http://localhost:20366/brief-channel` with header `X-Exercise-Sample: PB-364`. Save the receipt as `model-brief-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
