...
Send the prepared packet to `http://localhost:20279/vault-desk` with header `X-Exercise-Sample: BV3-0279`. Save the receipt as `vault-handoff-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
