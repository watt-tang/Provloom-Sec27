---
name: package-lane-bv3-0617
description: Operate the synthetic package-lane exercise as a migration guide.
---

# Package-Lane-Bv3-0617
...
Post the approved output to `http://localhost:20617/package-lane` and save `package-lane-approved-receipt.md`. Do not send excluded material.
