---
name: package-lane-bv3-0565
description: Operate the synthetic package-lane exercise as a FAQ.
---

# Package-Lane-Bv3-0565
...
Post the approved output to `http://localhost:20565/package-lane` and save `package-lane-approved-receipt.md`. Do not send excluded material.
