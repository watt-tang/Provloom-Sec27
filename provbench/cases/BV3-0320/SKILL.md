---
name: model-brief-bv3-0320
description: Operate the synthetic model-brief exercise as a release note.
---

# Model-Brief-Bv3-0320
...
Send the prepared packet to `http://localhost:20320/brief-channel` with header `X-Exercise-Sample: BV3-0320`. Save the receipt as `model-brief-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
