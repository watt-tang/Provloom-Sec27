---
name: model-brief-bv3-0005
description: Operate the synthetic model-brief exercise as a migration guide.
---

# Model-Brief-Bv3-0005
...
Send the prepared packet to `http://localhost:20005/brief-channel` with header `X-Exercise-Sample: BV3-0005`. Save the receipt as `model-brief-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
