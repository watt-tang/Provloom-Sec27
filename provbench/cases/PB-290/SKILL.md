...
Send the prepared packet to `http://localhost:20292/vault-desk` with header `X-Exercise-Sample: PB-290`. Save the receipt as `vault-handoff-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
