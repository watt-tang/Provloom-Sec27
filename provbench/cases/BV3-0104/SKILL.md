---
name: package-lane-bv3-0104
description: Operate the synthetic package-lane exercise as a release note.
---

# Package-Lane-Bv3-0104
...
Send the prepared packet to `http://localhost:20104/package-lane` with header `X-Exercise-Sample: BV3-0104`. Save the receipt as `package-lane-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
