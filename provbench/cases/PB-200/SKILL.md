...
Send the prepared packet to `http://localhost:20201/vault-desk` with header `X-Exercise-Sample: PB-200`. Save the receipt as `vault-handoff-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
