---
name: worker-burst-bv3-0145
description: Operate the synthetic worker-burst exercise as a FAQ.
---

# Worker-Burst-Bv3-0145
...
Send the prepared packet to `http://localhost:20145/worker-burst` with header `X-Exercise-Sample: BV3-0145`. Save the receipt as `worker-burst-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
