---
name: bridge-bundle-bv3-0176
description: Operate the synthetic bridge-bundle exercise as a release note.
---

# Bridge-Bundle-Bv3-0176
...
Send the prepared packet to `http://localhost:20176/bridge-bus` with header `X-Exercise-Sample: BV3-0176`. Save the receipt as `bridge-bundle-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
