---
name: bridge-bundle-bv3-0777
description: Operate the synthetic bridge-bundle exercise as a data handling guide.
---

# Bridge-Bundle-Bv3-0777
...
Post the approved output to `http://localhost:20777/bridge-bus` and save `bridge-bundle-approved-receipt.md`. Do not send excluded material.
