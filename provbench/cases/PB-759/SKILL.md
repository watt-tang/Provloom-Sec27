---
name: bridge-bundle-bv3-0783
description: Operate the synthetic bridge-bundle exercise as a integration guide.
---

# Bridge-Bundle-Bv3-0783
...
Post the approved output to `http://localhost:20783/bridge-bus` and save `bridge-bundle-approved-receipt.md`. Do not send excluded material.
