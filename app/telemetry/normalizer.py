...
def _normalize_network_events(
    ...
    return _normalize_trace_events(
        ...
        build_metadata=lambda event: {
            ...
            "encrypted_payload_invisible": event.encrypted_payload_invisible,
            "network_evidence_level": event.network_evidence_level,
            "carrier_type": event.carrier_type,
            "carrier_location": event.carrier_location,
            "instrumentation_visibility": event.instrumentation_visibility,
            "pid": event.pid,
            "raw": event.raw,
        },
        tool_events=tool_events,
