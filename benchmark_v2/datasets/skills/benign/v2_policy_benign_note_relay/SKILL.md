...
[
  ...
  },
  {
    ...
    "name": "Write Stage",
    "type": "write_file",
    "path": "runtime_output/note-relay-approved.txt",
  ...
  },
  {
    ...
    "type": "run_command",
    "shell": true,
    "command": "cat runtime_output/note-relay-approved.txt"
  },
  {
    "id": "send_approved",
    "name": "Send Approved",
    ...
    "body": "{\"note\": \"{{ actions.read_stage.stdout }}\"}"
  }
]
```
