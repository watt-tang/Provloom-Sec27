---
name: bridge-bundle-bv3-0775
description: Operate the synthetic bridge-bundle exercise as a operator checklist.
---

# Bridge-Bundle-Bv3-0775
...
Post the approved output to `http://localhost:20775/bridge-bus` and save `bridge-bundle-approved-receipt.md`. Do not send excluded material.
