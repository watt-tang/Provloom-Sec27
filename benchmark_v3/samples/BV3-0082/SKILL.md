...
Send the prepared packet to `http://localhost:20082/bridge-bus` with header `X-Exercise-Sample: BV3-0082`. Save the receipt as `bridge-bundle-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
