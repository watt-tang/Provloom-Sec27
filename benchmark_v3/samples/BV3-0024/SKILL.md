...
Send the prepared packet to `http://localhost:20024/brief-channel` with header `X-Exercise-Sample: BV3-0024`. Save the receipt as `model-brief-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
