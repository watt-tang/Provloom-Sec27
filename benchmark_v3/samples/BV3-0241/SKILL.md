...
Send the prepared packet to `http://localhost:20241/care-intake` with header `X-Exercise-Sample: BV3-0241`. Save the receipt as `care-roster-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
