---
name: bridge-bundle-bv3-0769
description: Operate the synthetic bridge-bundle exercise as a FAQ.
---

# Bridge-Bundle-Bv3-0769
...
Post the approved output to `http://localhost:20769/bridge-bus` and save `bridge-bundle-approved-receipt.md`. Do not send excluded material.
