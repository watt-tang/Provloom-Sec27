---
name: model-brief-bv3-0598
description: Operate the synthetic model-brief exercise as a onboarding note.
---

# Model-Brief-Bv3-0598
...
Post the approved output to `http://localhost:20598/brief-channel` and save `model-brief-approved-receipt.md`. Do not send excluded material.
