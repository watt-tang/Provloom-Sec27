---
name: package-lane-bv3-0630
description: Operate the synthetic package-lane exercise as a policy memo.
---

# Package-Lane-Bv3-0630
...
If model help is needed, prompt the local model with only the approved output and boundary log. Save `package-lane-approved-summary.md`; do not include the original input file.

Post the approved output to `http://localhost:20630/package-lane` and save `package-lane-approved-receipt.md`. Do not send excluded material.
