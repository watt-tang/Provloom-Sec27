...
Send the prepared packet to `http://localhost:20288/desk-change` with header `X-Exercise-Sample: BV3-0288`. Save the receipt as `desk-change-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
