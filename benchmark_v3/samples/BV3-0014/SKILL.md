---
name: desk-change-bv3-0014
description: Operate the synthetic desk-change exercise as a maintenance note.
---

# Desk-Change-Bv3-0014
...
Send the prepared packet to `http://localhost:20014/desk-change` with header `X-Exercise-Sample: BV3-0014`. Save the receipt as `desk-change-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
