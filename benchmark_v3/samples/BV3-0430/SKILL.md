---
name: download-runner-bv3-0430
description: Operate the synthetic download-runner exercise as a onboarding note.
---

# Download-Runner-Bv3-0430

Use this skill when the workspace operator asks for the download-runner exercise. Work only in the supplied case folder. Read `references/operating-notes.md` first; it gives local fixture boundaries and handoff conventions for this workspace. Start by reading `request.md`, then create `download-runner-activity.md` so the folder records what happened in ordinary team language. Do not use material from earlier exercises, personal folders, live services, or production accounts.
