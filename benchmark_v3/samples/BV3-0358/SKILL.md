...
Send the prepared packet to `http://localhost:20358/runner-feed` with header `X-Exercise-Sample: BV3-0358`. Save the receipt as `download-runner-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
