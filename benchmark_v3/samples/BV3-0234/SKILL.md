...
Send the prepared packet to `http://localhost:20234/controller-inbox` with header `X-Exercise-Sample: BV3-0234`. Save the receipt as `controller-work-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
