...
Send the prepared packet to `http://localhost:20286/controller-inbox` with header `X-Exercise-Sample: BV3-0286`. Save the receipt as `controller-work-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
