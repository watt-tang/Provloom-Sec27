...
Send the prepared packet to `http://localhost:20276/worker-burst` with header `X-Exercise-Sample: BV3-0276`. Save the receipt as `worker-burst-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
