...
Send the prepared packet to `http://localhost:20080/worker-burst` with header `X-Exercise-Sample: BV3-0080`. Save the receipt as `worker-burst-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
