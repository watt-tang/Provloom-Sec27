...
Send the prepared packet to `http://localhost:20274/package-lane` with header `X-Exercise-Sample: BV3-0274`. Save the receipt as `package-lane-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
