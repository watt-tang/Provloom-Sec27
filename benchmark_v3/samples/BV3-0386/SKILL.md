...
Send the prepared packet to `http://localhost:20386/bridge-bus` with header `X-Exercise-Sample: BV3-0386`. Save the receipt as `bridge-bundle-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
