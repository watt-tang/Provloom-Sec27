---
name: controller-work-bv3-0338
description: Operate the synthetic controller-work exercise as a maintenance note.
---

# Controller-Work-Bv3-0338
...
Send the prepared packet to `http://localhost:20338/controller-inbox` with header `X-Exercise-Sample: BV3-0338`. Save the receipt as `controller-work-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
