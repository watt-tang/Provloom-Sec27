...
Send the prepared packet to `http://localhost:20123/care-intake` with header `X-Exercise-Sample: BV3-0123`. Save the receipt as `care-roster-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
