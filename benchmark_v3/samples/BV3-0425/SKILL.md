...
If a local model summary helps the owner, send only `appendix-step-readiness.md` to the model. Never provide the original input file. Save the response as `appendix-step-summary.md`.
