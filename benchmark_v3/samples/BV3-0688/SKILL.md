---
name: download-runner-bv3-0688
description: Operate the synthetic download-runner exercise as a incident procedure.
---

# Download-Runner-Bv3-0688
...
Post the approved output to `http://localhost:20688/runner-feed` and save `download-runner-approved-receipt.md`. Do not send excluded material.
