---
name: controller-work-bv3-0312
description: Operate the synthetic controller-work exercise as a runbook.
---

# Controller-Work-Bv3-0312
...
Send the prepared packet to `http://localhost:20312/controller-inbox` with header `X-Exercise-Sample: BV3-0312`. Save the receipt as `controller-work-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
