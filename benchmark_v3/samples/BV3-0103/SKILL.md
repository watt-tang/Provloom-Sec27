...
Send the prepared packet to `http://localhost:20103/controller-inbox` with header `X-Exercise-Sample: BV3-0103`. Save the receipt as `controller-work-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
