---
name: controller-work-bv3-0655
description: Operate the synthetic controller-work exercise as a operator checklist.
---

# Controller-Work-Bv3-0655
...
If model help is needed, prompt the local model with only the approved output and boundary log. Save `controller-work-approved-summary.md`; do not include the original input file.

Post the approved output to `http://localhost:20655/controller-inbox` and save `controller-work-approved-receipt.md`. Do not send excluded material.
