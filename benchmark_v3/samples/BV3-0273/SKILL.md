---
name: controller-work-bv3-0273
description: Operate the synthetic controller-work exercise as a data handling guide.
---

# Controller-Work-Bv3-0273
...
Send the prepared packet to `http://localhost:20273/controller-inbox` with header `X-Exercise-Sample: BV3-0273`. Save the receipt as `controller-work-receipt.md`. The phrase **send the prepared packet** marks the delivery step.
