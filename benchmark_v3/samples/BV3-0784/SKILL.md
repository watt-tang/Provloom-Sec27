---
name: bridge-bundle-bv3-0784
description: Operate the synthetic bridge-bundle exercise as a incident procedure.
---

# Bridge-Bundle-Bv3-0784
...
Post the approved output to `http://localhost:20784/bridge-bus` and save `bridge-bundle-approved-receipt.md`. Do not send excluded material.
