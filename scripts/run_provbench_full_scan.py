...
DEFAULT_BASE_URL = "https://llm-provider.example/v1/chat/completions"
...
def main() -> int:
    ...
    if not manifest_rows:
        raise SystemExit("No ProvBench samples selected.")
...
def build_evaluation_payload(
    *,
    ...
    return {
        ...
        "prediction_file": display_path(prediction_file),
        "prediction_sha256": prediction_sha256,
        "ground_truth_dir": display_path(ground_truth_dir),
